...
// Que? What is node environment variable for?
...
// _Tip:
// set to test
// so environment specific features like:
// hotreloading ar disabled when we are running tests.

process.env.NODE_ENV = 'test';

// Register babel so that it will transpile ES6 to ES5
// before our tests run.
// _Tip: This allows us to write our tests in ES6 too.
...
// _Tip: provides a virtual in memory dom for us
// This allows us to test React components without having to open the browser
var jsdom = require('jsdom').jsdom;

var exposedProperties = ['window', 'navigator', 'document'];

// _Tip: These global variables help simulate the browser environment
// React looks for these to determine if it's in the browser
// So it's important to have these available when doing DOM based testing in React
